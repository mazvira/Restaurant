...
public class Reservation_Ordering_for_Client {
	...
	public Reservation_Ordering_for_Client() {
		frame = new JFrame("Бронювання столика/Замовлення їжі");
		...
		heading_lbl.setBounds(x, y, width + 40, height);
		y += 40;
		heading_lbl.setText("<html><font><u><b>Бронювання/Доставка</b></u></html>");
	...
	public static void order(ActionEvent event) {
		try {
			Reservation_Of_Halls_Tables rese = new Reservation_Of_Halls_Tables();
